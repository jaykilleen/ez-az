...
2. Run: `gh api "repos/jaykilleen/ez-az/issues?state=open&per_page=100&sort=created&direction=desc" --jq '.[] | {number: .number, title: .title, labels: [.labels[].name], created_at: .created_at, comments: .comments}'`
...
4. Re-fetch the open issues list after closing: `gh api "repos/jaykilleen/ez-az/issues?state=open&per_page=100&sort=created&direction=desc" --jq '.[] | {number: .number, title: .title, labels: [.labels[].name], created_at: .created_at, comments: .comments}'`
